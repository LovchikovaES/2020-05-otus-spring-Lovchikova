...
insert into users(id, name, username, password, enabled) values (2, 'User', 'user', '$2a$11$yRxuh20cOknH3KYQz5wZ6OoHBAHQHTGy8kVGfSpcxPXatFj32bEle', 1); -- password admin

insert into roles(id, name) values (1, 'ROLE_ADMIN');
insert into roles(id, name) values (2, 'ROLE_USER');

insert into CUSTOM_PRIVILEGES(id, name) values (1, 'READ');
insert into CUSTOM_PRIVILEGES(id, name) values (2, 'WRITE');

insert into ROLES_PRIVILEGES(role_id, PRIVILEGE_id) values (1, 1);
insert into ROLES_PRIVILEGES(role_id, PRIVILEGE_id) values (1, 2);
insert into ROLES_PRIVILEGES(role_id, PRIVILEGE_id) values (2, 1);

insert into USERS_ROLES(user_id, role_id) values (1, 1); -- у admin есть роль admin с привилегиями на read и write
insert into USERS_ROLES(user_id, role_id) values (2, 2); -- у user есть роль user с привилегиями на read